...
function Cn_t = Cn_calculation(Alpha, Beta, Del_h, del_lef, del_a, c, b, x_cg_ref, x_cg, r, V, beta)
    ...
    function Cn = Cn_lef(Alpha,Beta)
        [alpha,beta,Cn] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\C_n,lef(alpha,beta).txt');
    ...
    function Cn = Cn_alpha_beta_del_h_0(Alpha,Beta)
        [alpha,beta,Cn] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn(alpha,beta,del_h = 0).txt');
        F = scatteredInterpolant(alpha,beta,Cn,"linear");
        Cn = F(Alpha,Beta);
    end
    ...
    function Cn = Cn_del_a_20(Alpha,Beta)
        [alpha,beta,Cn] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn,del_a=20(alpha,beta).txt');
        F = scatteredInterpolant(alpha,beta,Cn,"linear");
        Cn = F(Alpha,Beta);
    end
    ...
    function Cn = Cn_del_a_20_lef(Alpha,Beta)
        [alpha,beta,Cn] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\C_n,del_a=20,lef(alpha,beta).txt');
        F = scatteredInterpolant(alpha,beta,Cn,"linear");
        Cn = F(Alpha,Beta);
    end
    ...
    function Cn = Cn_del_r_30(Alpha,Beta)
        [alpha,beta,Cn] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn,del_r=30(alpha,beta).txt');
        F = scatteredInterpolant(alpha,beta,Cn,"linear");
        Cn = F(Alpha,Beta);
    end
    ...
    function Cn = Cn_alpha_beta_del_h(Alpha,Beta,Del_h)
        data1 = readmatrix('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn(alpha,beta,del_h=-25).txt', 'Delimiter', ',');
        data2 = readmatrix('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn(alpha,beta,del_h = 0).txt', 'Delimiter', ',');
        data3 = readmatrix('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn(alpha,beta,del_h = 25).txt', 'Delimiter', ',');
    ...
    function Cn = Cn_r(Alpha)
        [alpha,Cn] = read_data1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn_r(alpha).txt');
        Cn = interp1(alpha,Cn,Alpha,'linear');
    end
    %fprintf('%.4f',Cn_r(30));

    function Cn = del_Cn_r_lef(Alpha)
        [alpha,Cn] = read_data1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\del_Cn_r,lef(alpha).txt');
        Cn = interp1(alpha,Cn,Alpha,'linear');
    end
    ...
    function Cn = Cn_p(Alpha)
        [alpha, Cn] = read_data1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\Cn_p(alpha).txt');
        Cn = interp1(alpha, Cn, Alpha, 'linear');
    end
    ...
    function Cn = del_Cn_p_lef(Alpha)
        [alpha, Cn] = read_data1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\del_Cn_p,lef(alpha).txt');
        Cn = interp1(alpha, Cn, Alpha, 'linear');
    end
   ...
   %fprintf('%.4f',del_Cn_p_lef(30));
    ...
    function Cn = del_Cn_beta(Alpha)
        [alpha, Cn] = read_data1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cn\del_Cn_beta(alpha).txt');
        Cn = interp1(alpha,Cn, Alpha, "linear");
    end
