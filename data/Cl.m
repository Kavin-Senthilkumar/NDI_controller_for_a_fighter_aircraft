...
function Cl = Cl_lef_alpha_beta(Alpha, Beta)
    [alpha, beta, Cl] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\C_l,lef(alpha,beta).txt');
...
function Cl = Cl_alpha_beta_del_h_0(Alpha, Beta)
    [alpha, beta, Cl] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\Cl(alpha,beta,del_h=0).txt');
    F = scatteredInterpolant(alpha, beta, Cl, 'linear');
    Cl = F(Alpha, Beta);
end
...
function Cl = Cl_del_a_20(Alpha, Beta)
    [alpha, beta, Cl] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\C_l,del_a=20(alpha,beta).txt');
    F = scatteredInterpolant(alpha, beta, Cl, 'linear');
    Cl = F(Alpha, Beta);
end
...
function Cl = Cl_del_a_20_lef(Alpha, Beta)
    [alpha, beta, Cl] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\C_l,del_a=20,lef(alpha,beta).txt');
    F = scatteredInterpolant(alpha, beta, Cl, 'linear');
    Cl = F(Alpha, Beta);
end
...
function Cl = Cl_del_r_30(Alpha, Beta)
    [alpha, beta, Cl] = read_data('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\C_l,del_r=30(alpha,beta).txt');
    F = scatteredInterpolant(alpha, beta, Cl, 'linear');
    Cl = F(Alpha, Beta);
end
...
function Cl = Cl_p(Alpha)
    [alpha, Cl] = read_data_1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\Cl_p(alpha).txt');
    Cl = interp1(alpha, Cl, Alpha, 'linear');
end

% Cl_r
function Cl = Cl_r(Alpha)
    [alpha, Cl] = read_data_1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\C_l_r(alpha).txt');
    Cl = interp1(alpha, Cl, Alpha, 'linear');
end

% del_Cl_p_lef
function Cl = del_Cl_p_lef(Alpha)
    [alpha, Cl] = read_data_1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\del_Cl_p,lef(alpha).txt');
    Cl = interp1(alpha, Cl, Alpha, 'linear');
end

% del_Cl_beta
function Cl = del_Cl_beta(Alpha)
    [alpha, Cl] = read_data_1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\del_Cl_beta(alpha).txt');
    Cl = interp1(alpha, Cl, Alpha, 'linear');
end

% del_Cl_r_lef
function Cl = del_Cl_r_lef(Alpha)
    [alpha, Cl] = read_data_1('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\del_Cl_r,lef(alpha).txt');
    Cl = interp1(alpha, Cl, Alpha, 'linear');
end

% Cl_alpha_beta_del_h
function Cl = Cl_alpha_beta_del_h(Alpha, Beta, Del_h)
    data1 = readmatrix('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\Cl(alpha,beta,del_h=-25).txt', 'Delimiter', ',');
    data2 = readmatrix('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\Cl(alpha,beta,del_h=0).txt', 'Delimiter', ',');
    data3 = readmatrix('C:\Users\deepa\NDI_controller_for_a_fighter_aircraft\data\aero_coeffs\Cl\Cl(alpha,beta,del_h=25).txt', 'Delimiter', ',');
